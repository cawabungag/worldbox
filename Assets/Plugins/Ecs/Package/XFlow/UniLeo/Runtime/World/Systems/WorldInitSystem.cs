...
using UnityEngine;
using XFlow.EcsLite;
using XFlow.UniLeo.Runtime.MonoHelpers;
using XFlow.UniLeo.Runtime.World.Components;

namespace XFlow.UniLeo.Runtime.World.Systems
{
    ...
    class WorldInitSystem : IEcsPreInitSystem, IEcsRunSystem, IEcsDestroySystem
    {
        ...
        public void Run(EcsSystems systems)
        {
            ...
            {
                ref InstantiateComponent instantiate = ref _instantiatePool.GetRef(i);
